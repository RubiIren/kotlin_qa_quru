...
class RegistrationTest : Controllers() {
    ...
    fun testCreateUserErrorNoUsername() {
        val response = users.createUser(CreateUserRequest("", "user@ast.com","123456")).getErrorAsObject<ErrorResponse>()
    ...
    fun testCreateUserErrorNoEmail() {
        val response = users.createUser(CreateUserRequest("User", "","123456")).getErrorAsObject<ErrorResponse>()
    ...
    fun testCreateUserErrorNoPassword() {
        val response = users.createUser(CreateUserRequest("Users", "user@ast.com","")).getErrorAsObject<ErrorResponse>()
    ...
    fun testLoginWithNullCredentials() {
        val response = users.createUser(CreateUserRequest("Users", "fdgfd@mail.re", "123456")).getErrorAsObject<ErrorResponse>()
